...
class StrongerEnigma:
    ...
    def __init__(self):
        ...
        configuration = [['EXVMGZYWJPIFQTUNLCKOBDHSRA', 7]]
        self.rotors = []
...
# conf = [['DRAGBVKJYILPSTQXOUHEWCZMNF', 7], ['IHNWXSKYGEBJFQLPZTVRCDOMUA', 19], ['QUOXNGDYJIZPWFAHERBTLSVKMC', 19], ['IXMASRJNCHGZEPVDOYKBQULWTF', 19], ['NCXLKIHTOFYDVEASGMUWRJQZPB', 17]]
# print(create_configuration())
config = ['DRAGBVKJYILPSTQXOUHEWCZMNF', 7]
enigma = StrongerEnigma.Rotor(config[0], config[1])
print(enigma.decrypt('E'))
print(chr(ord('A') + config[0].find('E')))

today_config = [['EXVMGZYWJPIFQTUNLCKOBDHSRA', 7]]
print('today configuration:', today_config)
enigma2 = StrongerEnigma()
print(enigma2.decrypt('GET'))
